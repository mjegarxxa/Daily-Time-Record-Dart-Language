...
class _HomePageState extends State<HomePage> {
  ...
  // This list now defines what appears for each tab
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: [
          // Background Image (Jeans Texture) - Stays visible on all tabs
          Container(
          ...
          // Swaps content based on _selectedIndex
  ...
  // --- HOME CONTENT WIDGET ---
  // We moved your dashboard UI here so it can be swapped
