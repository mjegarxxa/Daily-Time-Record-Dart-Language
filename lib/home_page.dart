...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _handleClockAction() async {
    ...
    try {
      ...
      if (distance <= radiusMeters) {
        ...
        _showErrorDialog(
          "Out of Range",
          "You are ${(distance - radiusMeters).toInt()}m away from the RRJ office.",
        );
      }
    } catch (e) {
      ...
      _showErrorDialog(
        "Location Error",
        "Could not verify your location. Please enable GPS.",
      );
    }
  }
          ...
          Expanded(
            child: Column(
              ...
              children: const [
                ...
                Text(
                  "Mark Joshua E. Garcia",
                  style: TextStyle(color: Colors.white, fontSize: 16),
                ),
                Text(
                  "BSIS - One Cainta College",
    ...
    return Row(
      ...
      children: [
        Text(
          ...
          style: TextStyle(
            fontSize: 16,
            color: isDark ? Colors.white70 : const Color(0xFF1A2E44),
          ),
        ),
        Text(
          value,
                          ...
                          RichText(
                            text: TextSpan(
                              style: TextStyle(
                                ...
                                color: isDark
                                    ? Colors.white
                                    : Colors.black, // Base color for labels
                              ),
                              children: [
                                ...
                                TextSpan(
                                  text: log.clockOut,
                                  style: TextStyle(
                                    color: _getOutColor(log.clockOut),
                                  ),
                                ),
                              ],
                            ),
  ...
  Widget _buildProgressSection() {
    bool isDark = isDarkModeNotifier.value;
    double progressValue = requiredHours > 0
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text(
                "${completedHours.toInt()} / $requiredHours hrs ($percentage%)",
  ...
  Color _getInColor(String time) {
    ...
    try {
      ...
      // Example: Red if later than 8:30 AM
      if (hour > 8 || (hour == 8 && minute > 30)) return Colors.red;
    } catch (e) {
      return Colors.black;
    }
    return const Color.fromARGB(255, 132, 212, 2); // Green for on-time
  }
  ...
  Color _getOutColor(String time) {
    ...
    try {
      ...
      int hour = int.parse(parts[0]);
      int minute = int.parse(parts[1]);
      // Example: Red if earlier than 5:30 PM (17:30)
      if (hour < 17 || (hour == 17 && minute < 30)) return Colors.red;
    } catch (e) {
      return Colors.black;
    }
    return const Color.fromARGB(255, 132, 212, 2); // Green
  }
}
