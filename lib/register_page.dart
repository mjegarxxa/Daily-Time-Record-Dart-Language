  ...
  Widget _buildPartTwo() {
    return Center(
      child: SingleChildScrollView(
        ...
        child: Column(
          mainAxisAlignment:
              MainAxisAlignment.center, // Vertically centers content
          crossAxisAlignment:
              CrossAxisAlignment.center, // Horizontally centers content
          children: [
            // Registration Title - now part of the sliding content
            Text(
              'Registration',
              style: TextStyle(
                fontFamily: 'Poppins',
            ...
            Container(
              ...
              child: Column(
                mainAxisSize:
                    MainAxisSize.min, // Constrains the box to its content
                children: [
                  _regField("Username"),
